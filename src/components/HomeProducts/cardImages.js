...
const cardImages = {
  weakConsumer: {
    ...
    img1: StarImage,
    subtitle1: 'Todas as ofertas',
    img2: PercentImage,
    subtitle2: 'Ofertas do dia',
    img3: LightningImage,
    subtitle3: 'Ofertas relâmpago',
    img4: TrophyImage,
    subtitle4: 'Melhores avaliadas'
  },
  devices: {
    title: 'Até R$250 off em Dispositivos Amazon',
    img1: EchoDotImage,
    subtitle1: 'Echo Dot 3ª geração',
    img2: FireTvImage,
    subtitle2: 'Fire Tv Stick',
    img3: KindleImage,
    subtitle3: 'Kindle 10ª geração',
    img4: EchoShowImage,
    subtitle4: 'Echo Show 8 1ª geração',
  }
}
